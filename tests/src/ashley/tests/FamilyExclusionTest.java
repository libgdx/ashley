...
public class FamilyExclusionTest {
	public static void main(String[] args) throws IOException {
		...
		engine.addSystem(new DummySystem());
		engine.addEntity(e1);
		engine.addEntity(e2);
		engine.addEntity(e3);

		Family f1 = Family.getHashedFamily( Family.getFamilyForOne(CameraComponent.class, VisualComponent.class) );
		...
		Family f2 = Family.getHashedFamily( Family.getFamilyForAll(NameComponent.class, PositionComponent.class));
	...
	private static class DummySystem extends IteratingSystem {
        
		public DummySystem(){
			super(Family.getFamilyForOne(CameraComponent.class, VisualComponent.class));
		}
