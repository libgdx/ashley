...
/**
 * A simple EntitySystem that iterates over each entity and calls
 * processEntity() for each entity every time the EntitySystem is updated. This
 * is really just a convenience class as most systems iterate over a list of
 * entities.
 *
...
public abstract class IteratingSystem extends EntitySystem {
        ...
        /**
         * Instantiates a system that will iterate over the entities described
         * by the Family.
         *
        ...
        /**
         * Instantiates a system that will iterate over the entities described
         * by the Family, with a specific priority.
         *
         * @param family The family of entities iterated over in this System
