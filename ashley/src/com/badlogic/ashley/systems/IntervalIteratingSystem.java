...
/**
 * A simple {@link EntitySystem} that processes a {@link Family} of entities not
 * once per frame, but after a given interval. Entity processing logic should be
 * placed in {@link IntervalIteratingSystem#processEntity(Entity)}.
 *
